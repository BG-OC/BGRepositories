#
#  Be sure to run `pod spec lint BGConfirmOrder.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/BG-OC/BGConfirmOrder.git", :tag => s.version }
